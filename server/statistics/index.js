...
const { handleErrorResponse, getKeyByValue, stringToBool, getSeasonText } = require('../utils/common');
...
const attachEpisodeStatistics = async ({ isAdult }, parents) => {
  ...
  return parents.map(item => {
    ...
    return {
      ...
      episodeStatistics: { ...emptyEpisodeStatistic(), ...episodeStatistics, mode: Functions.getModeRating(episodeRatings) }
    }
  });
}
