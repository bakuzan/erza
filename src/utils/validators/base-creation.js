...
import {getUniquePropertiesForItemType, getHistoryNameForItemType} from '../data'
...
const processValidatorChanges = ({ history, uniqueProperties }) => (item, property) => {
  switch(property) {
    case Properties[history]  : return historyChangeHandler(uniqueProperties)(item);
    case Properties.status    : return statusChangeHandler(item);
    case Properties.isRepeat  : return repeatChangeHandler(uniqueProperties)(item);
    default                   : return {};
  }
}
