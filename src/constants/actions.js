...
export const LAST_LOCATION_UPDATE = 'LAST_LOCATION_UPDATE';

export const FILTERS_TOGGLE_IS_OWNED_ONLY = 'FILTERS_TOGGLE_IS_OWNED_ONLY';

export const LOAD_REPEAT_HISTORY = 'LOAD_REPEAT_HISTORY';
export const LOAD_HISTORY_AVERAGES = 'LOAD_HISTORY_AVERAGES';
